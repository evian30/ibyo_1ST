<%--
  Class Name  : devCsrInfoMngList.jsp
  Description : 개발요청정보 관리
...
var gridTitle_1st 		= "개발요청정보관리";	  	// 그리드 제목
...
var	gridTitle_edit_1st  =   "개발요청 상세정보"	; 
						...
						<div class="x-panel-tr">
							<div class="x-panel-tc">
								<div id="ext-gen4" class="x-panel-header x-unselectable" style="-moz-user-select: none;">
									<span id="ext-gen8" class="x-panel-header-text">개발요청정보 검색</span>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="x-panel-mc" >
								<table border="0" width="100%"  style="font-size: 12px">
									...
									<tr>
										...
										<td width="30%">
											<div tabindex="-1" class="x-form-item " >
												<label class="x-form-item-label" style="width: auto;" for="src_task_group_code">개발요청구분 :</label>
												<div style="padding-left: 30px;" class="x-form-element">
													<input type="hidden" id="src_csr_type_code" name="src_csr_type_code" style="width:80px"  value="10" />
													<select name="src_csr_type_code" id="src_csr_type_code" style="width: 29%;" type="text" class=" x-form-select x-form-field" disabled >
						...
						<div class="x-panel-tr">
							<div class="x-panel-tc">
								<div class="x-panel-header x-unselectable" style="-moz-user-select: none;">
									<span class="x-panel-header-text">개발요청 기본정보</span><!----------------- 이름변경 ----------------->		
								</div>
							</div>
						</div>
					</div>
						...
						<div class="x-panel-ml">
							<div class="x-panel-mr">
								<div class="x-panel-mc" >
									...
									<input type="hidden" id="csr_dept_code" name="csr_dept_code" style="width:80px" />
												...
												<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
													<div tabindex="-1" class="x-form-item " >
														...
														<div style="padding-left: 83px;" class="x-form-element">
															<input type="hidden" id="csr_type_code" name="csr_type_code" style="width:80px"  value="10" />
															<select name="csr_type_code" id="csr_type_code" style="width: 29%;" type="text" class=" x-form-select x-form-field" disabled >
																<option value="">전체</option>
																<c:forEach items="${SR_TYPE_CODE}" var="data" varStatus="status">
																	<c:if test="${data.COM_CODE != '20'}">
																		<option value="${data.COM_CODE}" <c:if test="${data.COM_CODE == '10'}">selected</c:if>><c:out value="${data.COM_CODE_NAME}"/></option>
