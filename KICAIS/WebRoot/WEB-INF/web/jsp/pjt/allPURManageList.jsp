 ...
 * 초기값 설정
 ***************************************************************************/
var	gridHeigth_1st	=	380;
var	gridWidth_1st 	=  	400;
var	gridTitle_1st   =	"구매 목록"; 
...
var userColumns_1st =  [
					...
					,{header: "프로젝트명",	 	width: 100 ,sortable: true, dataIndex: 'PJT_NAME', 			editor: new Ext.form.TextField({}) , hidden : true}
				   ];
var userColumns_edit_1st =  [
					...
					,{header: "거래처이름",  	sortable: true, dataIndex: 'CUSTOM_NAME',  	editor: new Ext.form.Label({})		,renderer:changeBLUE}
					,{header: "품목코드",  	sortable: true, dataIndex: 'ITEM_CODE',  	editor: new Ext.form.Label({}) 		, hidden : true}
					,{header: "품목이름",  	sortable: true, dataIndex: 'ITEM_NAME',  	editor: new Ext.form.Label({}) ,renderer:changeBLUE}
					,{header: "규격",		sortable: true, dataIndex: 'STANDARD',  	editor: new Ext.form.Label({}) }
...
var userColumns_edit_2nd =  [
					{header: "구매ID",  	 	sortable: true, dataIndex: 'PUR_ID', 	 		editor: new Ext.form.TextField({}) , hidden : true}
					,{header: "순번",  		sortable: true, dataIndex: 'PUR_INFO_SEQ',  	editor: new Ext.form.TextField({}) , hidden : true}
					,{header: "품목이름",  	sortable: true, dataIndex: 'ITEM_NAME',  		editor: new Ext.form.Label({}) }
					,{header: "품목코드", 	sortable: true, dataIndex: 'ITEM_CODE',  		editor: new Ext.form.Label({}) , hidden : true}
...
function fnPagingValue_1st(){
	...
	try{
		...
		GridClass_1st.store.setBaseParam('pur_id'                	    ,Ext.get('pur_id').getValue());
...
Ext.onReady(function() {
	...
	*/
	...
	Ext.get('pjt_id').on('click', function(e){	
		...
		param = "multiSelectYn=" + multiSelectYn + "&fieldName=" + fieldName + "&pjt_type_code=" +  pjt_type_code;
		fnPjtPop(param);
	});
			...
			<td width='60%'>
				<div class=" x-panel x-form-label-left" style=" width: 100%;"><%-- 0em <- 1em으로 수정하면 상위 공백 --%>
					...
					<table width="580" border="0">
						...
						<!-- 신규버튼 시작-->
						<tr>
							<td colspan='2' style="padding-right: 40">
								<div tabindex="-1" class="x-form-item" >
									<table cellspacing="0" class="x-btn  x-btn-noicon" style="width: 75;padd" align="right">
						...
						<tr>
							<td width='275'>
								<!-- 구매구분 시작 -->
								<div tabindex="-1" class="x-form-item "  style="width: 100%;">
									...
									<select name="pur_type_code" id="pur_type_code" class=" x-form-select x-form-field" style="width:164" >
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_date" id="pur_date" autocomplete="off" class=" x-form-text x-form-field" size='28'
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_id" id="pur_id" autocomplete="off" class=" x-form-text x-form-field" size="28" style="width: auto;" disabled="true" >
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_name" id="pur_name" autocomplete="off" class=" x-form-text x-form-field" size="28" style="width: auto;">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left: 80;" class="x-form-element">
									<select name="roll_type_code" id="roll_type_code" " type="text" class=" x-form-select x-form-field" style="width:164">
										<option value="">-----선택 하세요-----</option>
													...
													<table style="width: 160px;" cellspacing="0" class="x-btn  x-btn-noicon">
														<tr>
															<td>
																...
																<input type="text" name="pur_dept_name" id="pur_dept_name" size="8" autocomplete="off" class=" x-form-text x-form-field">
																...
																<input type="text" name="pur_emp_name" id="pur_emp_name" size="5" autocomplete="off" class=" x-form-text x-form-field">
															</td>
															<td>
																<%-- Button Start--%>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pjt_id" id="pjt_id" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pay_no" id="pay_no" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_total_amt" id="pur_total_amt" autocomplete="off" class=" x-form-text x-form-field" size="28" readOnly='true'>
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_total_tax" id="pur_total_tax" autocomplete="off" class=" x-form-text x-form-field" size="28" readOnly='true'>
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="in_date" id="in_date" autocomplete="off" class=" x-form-text x-form-field" size="28"
										onFocus="restoreDateString(this, this.value)" onKeydown="_chkKeyPressNumPoint(this)" onblur="isValidDate(this, this.value)"/>
									</div>
									<div class="x-form-clear-left">
									</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="pur_report_num" id="pur_report_num" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left: 80;" class="x-form-element">
									<select name="inspect_yn" id="inspect_yn" style="width:164" class=" x-form-select x-form-field" >
										<option value="">-----선택 하세요-----</option>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="inspect_date" id="inspect_date" autocomplete="off" class=" x-form-text x-form-field" size="28"
										onFocus="restoreDateString(this, this.value)" onKeydown="_chkKeyPressNumPoint(this)" onblur="isValidDate(this, this.value)"/>
									</div>
									<div class="x-form-clear-left">
									</div>
						...
						<tr>
							<td width='275'>
								<div class=" x-panel x-column" style="width: 100%;" >
									<div class="x-panel-bwrap" >
										<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
											<div tabindex="-1" class="x-form-item " >
												<label class="x-form-item-label" style="width: auto;" for="pjt_reg_emp_num" ><font color="red">* </font>검수자:</label>
												<div style="padding-left: 80px;" class="x-form-element">
													<table style="width: 165px;" cellspacing="0" class="x-btn  x-btn-noicon">
														<tr>
															<td>
																<input type="hidden" name="inspect_dept_code" id="inspect_dept_code" autocomplete="off" class=" x-form-text x-form-field" size="8">
																<input type="hidden" name="inspect_dept_name" id="inspect_dept_name" autocomplete="off" class=" x-form-text x-form-field" size="8">
																<input type="hidden" name="inspect_emp_num" id="inspect_emp_num" autocomplete="off" class=" x-form-text x-form-field" size="6">
																<input type="text" name="inspect_emp_name" id="inspect_emp_name" autocomplete="off" class=" x-form-text x-form-field" size="20">
															</td>
															<td>
																<%-- Button Start--%>
																<table cellspacing="0" class="x-btn  x-btn-noicon" style="width: 20px;" align="right">
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="inspect_desc" id="inspect_desc" autocomplete="off" class=" x-form-text x-form-field" size="28"/>
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="use_date" id="use_date" autocomplete="off" class=" x-form-text x-form-field" size="28"
										onFocus="restoreDateString(this, this.value)" onKeydown="_chkKeyPressNumPoint(this)" onblur="isValidDate(this, this.value)"/>
									</div>
									<div class="x-form-clear-left">
									</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										...
										<input type="text" name="use_emp_name" id="use_emp_name" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
							...
							<td colspan='2'>
								...
								<div tabindex="-1" class="x-form-item " >
									<div tabindex="-1" class="x-form-item " >
										...
										<div style="padding-left: 80;" class="x-form-element">
											<textarea type="text" id="note" name="note" style="width:450"></textarea>
										</div>
									</div>
								</div>
								<!-- 비고 종료-->
						...
						<tr>
							<td colspan='2'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left: 80;" class="x-form-element">
									<select name="proc_status_code" id="proc_status_code"  type="text" class=" x-form-select x-form-field" style="width:164">
										<option value="">-----선택 하세요-----</option>
						...
						<tr>
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="final_mod_id" id="final_mod_id" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
							...
							<td width='275'>
								...
								<div tabindex="-1" class="x-form-item " >
									...
									<div style="padding-left:80;" class="x-form-element">
										<input type="text" name="final_mod_date" id="final_mod_date" autocomplete="off" class=" x-form-text x-form-field" size="28">
									</div>
									<div class="x-form-clear-left">
									</div>
								</div>
