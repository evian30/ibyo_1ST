...
var gridTitle_1st 		= "프로젝트 기본정보"; 				// 그리드 제목
...
function fnPagingValue_1st(){
	...
	try{
		...
		GridClass_1st.store.setBaseParam('src_pjt_date_from'            ,Ext.get('src_pjt_date_from').getValue().replaceAll("-", ""));
		GridClass_1st.store.setBaseParam('src_pjt_date_to'              ,Ext.get('src_pjt_date_to').getValue().replaceAll("-", ""));
...
var userColumns_1st =  [ 	  {header: '상태'                ,width: 60  ,sortable: true ,dataIndex:'FLAG'              ,hidden : true}          
							...
							, {header: '프로젝트구분코드'  	,width: 100 ,sortable: true ,dataIndex:'PJT_TYPE_CODE'      ,hidden : true}                                  
							, {header: '프로젝트명'  			,width: 80  ,sortable: true ,dataIndex:'PJT_NAME'            }                    
...
var	userColumns_edit_1st	= [  
								 {header: "flag"           		,	width: 10,	sortable: true,	dataIndex: "FLAG"       		,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}	
			,{id: "pjt_info_seq", header: "순번"            		,	width: 10,	sortable: true,	dataIndex: "PJT_INFO_SEQ"       ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
								,{header: "등록일자"        		,	width: 10,	sortable: true,	dataIndex: "PJT_REG_DATE"       ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
								,{header: "프로젝트ID"      		,	width: 50,	sortable: true,	dataIndex: "PJT_ID"             ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
								...
								,{header: "거래처유형코드"      	,	width: 50,	sortable: true,	dataIndex: "CUSTOM_PATTERN_NM"  ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true}
								
								,{header: "거래처코드"      		,	width: 50,	sortable: true,	dataIndex: "CUSTOM_CODE"        ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true}
								,{header: "* 거래처명"      		,	width: 50,	sortable: true,	dataIndex: "CUSTOM_NAME"        ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false, renderer: changeBLUE}
								
								,{header: "거래처담당자번호"		,	width: 50,	sortable: true,	dataIndex: "COSTOMER_NUM"       ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true}
																
								,{header: "담당자부서"			,	width: 35,	sortable: true,	dataIndex: "CUSTOMER_DEPT"  	,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false}
								,{header: "* 거래처담당자"			,	width: 50,	sortable: true,	dataIndex: "COSTOMER_NAME"      ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false, renderer: changeBLUE}
								
								,{header: "담당자직위"			,	width: 35,	sortable: true,	dataIndex: "CUSTOMER_POSITION"  ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false}
								,{header: "담당자전화"			,	width: 40,	sortable: true,	dataIndex: "CUSTOMER_TELEPHONE" ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false}
								
								,{header: "당사와계약"			,	width: 35,	sortable: true, dataIndex: 'CONSTRACT_YN'		, 		editor: CONSTRACT_YN_COMBO  ,renderer: Ext.util.Format.comboRenderer(CONSTRACT_YN_COMBO)}
								,{header: "비고"            		,	width: 100,	sortable: true,	dataIndex: "NOTE"               ,		editor: new Ext.form.TextField({ allowBlank : true })}
								
								,{header: "최종변경자"    		,	width: 50,	sortable: true,	dataIndex: "FINAL_MOD_ID"       ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false}
								,{header: "최종변경일"    		,	width: 50,	sortable: true,	dataIndex: "FINAL_MOD_DATE"     ,		editor: new Ext.form.TextField({ allowBlank : true }), editable:false}
								,{header: "최초등록일"      		,	width: 50,	sortable: true,	dataIndex: "REG_DATE"           ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
								,{header: "최초등록자"      		,	width: 510,	sortable: true,	dataIndex: "REG_ID"             ,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
...
var	mappingColumns_edit_1st	= [  
								...
								,{name: "CUSTOMER_DEPT"  	 , 		type:"string", mapping: "CUSTOMER_DEPT"      }
								,{name: "CUSTOMER_POSITION"  , 		type:"string", mapping: "CUSTOMER_POSITION"  }
								,{name: "CUSTOMER_TELEPHONE" , 		type:"string", mapping: "CUSTOMER_TELEPHONE" }
...
var	userColumns_edit_2nd	= [ 
								 {header: "flag"           		,	width: 10,	sortable: true,	dataIndex: "FLAG"       		,		editor: new Ext.form.TextField({ allowBlank : true }), hidden:true, editable:false}
								,{header: "순번"     		,	width: 10,	sortable: true,	dataIndex: "PJT_INFO_SEQ"		,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true}
								,{header: "등록일자"   		,	width: 10,	sortable: true,	dataIndex: "PJT_REG_DATE"		,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true, editable:false}
								,{header: "프로젝트ID" 		,	width: 60,	sortable: true,	dataIndex: "PJT_ID"      		,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true, editable:false}
								
								,{header: "품목코드"   		,	width: 10,	sortable: true,	dataIndex: "ITEM_CODE"   		,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true}
								,{header: "* 품목"   		,	width: 100,	sortable: true,	dataIndex: "ITEM_NAME"   			,	editor: new Ext.form.TextField({ allowBlank : true }) , editable:false, renderer: changeBLUE}
								
								,{header: "CPU수"  			,	width: 25,	sortable: true,	dataIndex: "CPU_CNT"      		,	editor: new Ext.form.TextField({ allowBlank : true }) }
								,{header: "CORE수" 			,	width: 25,	sortable: true,	dataIndex: "CORE_CNT"    		,	editor: new Ext.form.TextField({ allowBlank : true }) }
								,{header: "수량"     		,	width: 25,	sortable: true,	dataIndex: "CNT"         		,	editor: new Ext.form.TextField({ allowBlank : true }) }
								,{header: "단가"     		,	width: 40,	sortable: true,	dataIndex: "UNIT_PRICE"  		,	editor: new Ext.form.TextField({ allowBlank : true }) , editable:false, renderer: korMoneyChangeRED, align:'right'}	
								,{header: "금액"     		,	width: 40,	sortable: true,	dataIndex: "AMT"         		,	editor: new Ext.form.TextField({ allowBlank : true }) , editable:false, renderer: korMoneyChangeRED, align:'right'}	
								,{header: "세액"     		,	width: 40,	sortable: true,	dataIndex: "TAX"         		,	editor: new Ext.form.TextField({ allowBlank : true }) , editable:false, renderer: korMoneyChangeRED, align:'right'}	
								,{header: "비고"     		,	width: 100,	sortable: true,	dataIndex: "NOTE"        		,	editor: new Ext.form.TextField({ allowBlank : true }) }	
								,{header: "최종변경자"  		,	width: 50,	sortable: true,	dataIndex: "FINAL_MOD_ID"   	,	editor: new Ext.form.TextField({ allowBlank : true }) ,  editable:false}
								,{header: "최종변경일"   		,	width: 50,	sortable: true,	dataIndex: "FINAL_MOD_DATE" 	,	editor: new Ext.form.TextField({ allowBlank : true }) ,  editable:false}
								,{header: "최초등록일"    	,	width: 50,	sortable: true,	dataIndex: "REG_DATE"       	,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true, editable:false}
								,{header: "최초등록자"    	,	width: 50,	sortable: true,	dataIndex: "REG_ID"         	,	editor: new Ext.form.TextField({ allowBlank : true }) , hidden:true, editable:false}
...
function fnInitValue(obj){
	...
	dForm.pjt_own_emp_num.value 	= "${sabun}";
	dForm.pjt_own_emp_nm.value 		= "${admin_nm}";
	dForm.pjt_own_dept_code.value 	= "${dept_code}";
	dForm.pjt_own_dept_nm.value 	= "${dept_nm}";
	...
	dForm.pay_free_code.value 		= "1";
	
	dForm.pjt_date_from.value 		= getTimeStamp().trim();
	dForm.pjt_date_to.value 		= getTimeStamp().trim();
...
function fnSearch(){  	
	...
	Ext.Ajax.request({   
		url: "/pjt/pjtManage/result_1st.sg"
		,method : 'POST'   
		,success: function(response){						// 조회결과 성공시
...
function fnSave(){  	
	...
	Ext.Ajax.request({   
		url: "/pjt/pjtManage/actionPjtManage.sg"
		,success: function(response){						// 조회결과 성공시
					// 조회된 결과값, store명
...
Ext.onReady(function() {
  ...
  //저장 버튼 -> 데이터를 server로 전송
	...
	// 검색시작일자
	var _src_pjt_date_from = new Ext.form.DateField({
	...
	// 검색종료일자
	var _src_pjt_date_to = new Ext.form.DateField({
...
function fnCostomerPopValue(records){ 
	...
	var custom_code = records[0].data.CUSTOM_CODE;
	var custom_name = records[0].data.CUSTOM_NAME;
	
	var customer_dept = records[0].data.CUSTOMER_DEPT;
	var customer_position = records[0].data.CUSTOMER_POSITION;
	var customer_telephone = records[0].data.CUSTOMER_TELEPHONE;
	
	 
	record.set('COSTOMER_NAME', costomer_name);
	record.set('COSTOMER_NUM', costomer_num); 
	
	record.set('CUSTOM_CODE', custom_code);
	record.set('CUSTOM_NAME', custom_name);
	
	record.set('CUSTOMER_DEPT', customer_dept);
	record.set('CUSTOMER_POSITION', customer_position);
	record.set('CUSTOMER_TELEPHONE', customer_telephone);
}
...
// 견적 품목정보 금액 계산
function fnCalculateItemAmt(){
	
	// 견적 품목정보 금액 계산
	var rowCnt = GridClass_edit_2nd.store.getCount();  	// Grid의 총갯수
	var exp_sal_total_amt = 0;							// 예상매출총액
	...
	if( rowCnt > 0){
		...
		for(i = 0 ; i < rowCnt ; i++){
			...
			var cnt = parseInt(GridClass_edit_2nd.store.data.items[i].data.CNT);
			var unit_price = parseInt(GridClass_edit_2nd.store.data.items[i].data.UNIT_PRICE);
			
			var amt = cnt * unit_price;			// 금액 = 수량 * 단가
			var tax = parseInt(amt * 0.1);		// 세액 = 금액 * 0.1
			
			record.set('AMT', fnIsNaN(amt));	// 금액
			record.set('TAX', fnIsNaN(tax));	// 세액
		
			exp_sal_total_amt += fnIsNaN(parseInt(amt));
			
		}// end for
	
		Ext.get('exp_sal_total_amt').set({value:MoneyComma(exp_sal_total_amt)});
							...
							<div class="x-panel-mc" > 
								<table border="0" width="100%">
									...
									<tr>
										...
										<td colspan="3" align="">
											<div tabindex="-1" class="x-form-item " >
												<label class="x-form-item-label" style="width: auto;" for="src_pjt_date_from" ><font color="red"> </font>시작기간 :</label>
												<div style="padding-left: 70px;" class="x-form-element">
													<table>
														<tr>
															<td>
										...
										<div class=" x-panel x-column" style="width: 80%;">
											<div class="x-panel-bwrap" >
												<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
													<div tabindex="-1" class="x-form-item " >
														<font color="red">* 주의 : 유지보수를 위한 기존프로젝트 등록시 매출총액은 0원이여야 합니다. </font>
													</div>
												</div>
											</div>
										</div>
										<div class=" x-panel x-column" style="width: 18%;">
											<div class="x-panel-bwrap" >
												<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
													<div tabindex="-1" class="x-form-item " >
													...
													<div tabindex="-1" class="x-form-item " >
														...
														<div style="padding-left: 80px;" class="x-form-element">
															<table style="width: 175px;" cellspacing="0" class="x-btn  x-btn-noicon">
																<tr>
																	<td>
																		<input type="hidden" name="pjt_own_emp_num" id="pjt_own_emp_num" autocomplete="off" size="7" class=" x-form-text x-form-field" style="width: auto;" readonly="readonly"/>
																		<input type="text" name="pjt_own_dept_nm" id="pjt_own_dept_nm" autocomplete="off" size="11" class=" x-form-text x-form-field" style="width: auto;" readonly="readonly"/>
																		<input type="text" name="pjt_own_emp_nm" id="pjt_own_emp_nm" autocomplete="off" size="6" class=" x-form-text x-form-field" style="width: auto;" readonly="readonly"/>
																		<input type="hidden" name="pjt_own_dept_code" id="pjt_own_dept_code" autocomplete="off" size="7" class=" x-form-text x-form-field" style="width: auto;" readonly="readonly"/>
																	</td>
																	<td>
																		<%-- Button Start--%>
																		<div style="padding-left: 0px;" >
																			<img align="center" id="ownEmpNumBtn" name="ownEmpNumBtn" alt="" src="/resource/images/bass_1st/icon_src1.gif" style="cursor: hand;">
																		</div>
																		<%-- Button End--%>
																	</td>
																</tr>
											...
											<div class="x-panel-bwrap" >
												<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
													<div tabindex="-1" class="x-form-item " >
														...
														<div style="padding-left: 80px;" class="x-form-element">
															<textarea name="pjt_summary" id="pjt_summary" autocomplete="off" class=" x-form-text x-form-field" style="width:98%; height:60px"></textarea>
														</div>
														<div class="x-form-clear-left">
														</div>
													</div>
											...
											<div class="x-panel-bwrap" >
												<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
													<div tabindex="-1" class="x-form-item " >
														...
														<div style="padding-left: 80px;" class="x-form-element">
															<textarea name="note" id="note" autocomplete="off" class=" x-form-text x-form-field" style="width:98%; height:60px"></textarea>
														</div>
														<div class="x-form-clear-left">
														</div>
													</div>
