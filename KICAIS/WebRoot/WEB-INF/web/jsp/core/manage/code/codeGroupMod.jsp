...
function jf_submit(){
	...
	document.vForm.action = "./codeGroupModify.sg";
...
<input type='hidden' name='command' value='add'>
			<table width="100%" height="29" border="1" cellpadding="0" cellspacing="0" id="fig1_01" summary="검색테이블" >
				<tr>
					<th id="list02" width='100'>그룹코드</td>
					<td>
						<input type='text' name='cd_gid' maxlength='10' size='5' value='${groupInfo.CD_GID }' readonly>
					</td>
				</tr>
				<tr>
					<th id="list02" width='100'>그룹명</td>
					<td>
						<input type='text' name='cd_gnm' maxlength='40' size='10' value='${groupInfo.CD_GNM }'>
					</td>
				</tr>
				<tr>
					<td colspan='2' align='center'>
						<input type="button" class="green_txt_b" value="수정" style="margin-right:10px;" onclick="javascript:jf_submit()">
