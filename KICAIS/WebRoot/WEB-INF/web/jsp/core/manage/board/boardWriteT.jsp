...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  id="table_gray" rules="cols" summary="관리자 관리" class="grid" rules="cols">
	<tr>
		<th scope="col" id="odd">이름</th><td><input type='text' name='board_write' value="${sessionMap.ADMIN_NM }" size="25"></td>
	</tr> 
	<tr>
		<th scope="col" id="odd">이메일</th><td width=200><input type='text' name='board_mail' style="width:300px" value="${sessionMap.ADMIN_MAIL }" size="25" /></td>
	</tr> 
	<tr>
		<th scope="col" id="odd">공개여부</th>
		<td>
			<input type="radio" name="secret01" value="Y" checked> 공개 
			<input type="radio" name="secret01" value="N"> 비공개
		</td>
	</tr>
	<!-- 
	<tr>
	...
	<tr>
		...
		<td>
			<input type='text' name='board_title' size='60' maxlength='100'>
			<c:if test="${boardInfo.NOTICE_YN == 'Y'}"><input type='checkbox' name='noticeyn01'>공지사항</c:if>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<!-- EDITE 시작-->
							<table width='100%' cellspacing="0" cellpadding="0" border="o">
								<tr>
									<td>
...
<img src='/resource/images/edit/line.gif'>
								...
								<tr>
									...
									<textarea id='contentID' style='display:none' name='content'></textarea>									
