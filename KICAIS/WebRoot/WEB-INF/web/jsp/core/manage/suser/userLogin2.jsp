...
#login_m{
	width:320px;
	height:91px;
	background:url(/resource/images/is_images/bg_login_mid-1.jpg) no-repeat;float:left;
	font-size: 12px;
}
#idinfo{
    padding-top:24px;
...
<body>
			...
			<div id="idinfo">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<input name="admin_id" type="text" class="search_input" size="14" />
						</span></td>
						<td width="54" rowspan="2"><input type="image" src="/resource/images/is_images/btn_login.gif"  border=0 alt="로그인버튼"/></td>
					</tr>
					<tr>
						<td><span class="l">
						<input name="admin_pw" type="text" class="search_input" size="14" />
						</span></td>
					</tr>
					</form>
					<tr>
	...
	<!-- wrap end --> 	<div id="wrap">
		<div id="login_t">
			<img src="/resource/images/is_images/bg_login_top-1.jpg" alt="로긴탑배경" />
		</div>
		<div id="login_m">
			<div id="idinfo">
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="60">아이디</td>
						<td width="105"><a href="#"><span class="l">
					    <input name="input" type="text" class="search_input" size="14" />
						</span></a><a href="#"></a></td>
					    <td  rowspan="2"><a href="#"><img src="/resource/images/is_images/btn_login.gif"  border="0" alt="로그인버튼"/></a></td>
					</tr>
					<tr>
						<td>비밀번호</td>
					    <td><a href="#"><span class="l">
					      <input name="input2" type="text" class="search_input" size="14" />
					    </span></a></td>
					</tr>
				</table>
		  </div>
		...
		<div id="login_f">
			<img src="/resource/images/is_images/bg_login_bottom-1.jpg" alt="로긴푸터" />
		</div>
	</div>
