<%--
  Class Name  : orderProcessStateManage.jsp
...
var gridTitle_edit_3rd 		= "수주진행상태";	  			// 그리드 제목
...
var userColumns_edit_3rd = [ {header : '상태'                	,width : 0 ,sortable : true , dataIndex : 'FLAG'               ,hidden : true}              
						   ...
						   , {header : '진행상태코드'          	,width : 60 ,sortable : true , dataIndex : 'PROC_STATUS_CODE' 	,editor: FLOW_STATUS_CODE_COMBO  ,renderer: Ext.util.Format.comboRenderer(FLOW_STATUS_CODE_COMBO)} 
						   , {header:  '이슈등록'			    ,width : 40  ,sortable : true , dataIndex : 'REG_ISSUE'   		,renderer: changeBLUE}
						   ...
						   , {header : '수주ID'					,width : 70 ,sortable : true , dataIndex : 'ORD_ID' 			}
						   ...
						   , {header : '프로젝트'				,width : 60 ,sortable : true , dataIndex : 'PJT_NAME' 			}
						   ...
						   , {header : '특이사항'				,width : 60 ,sortable : true , dataIndex : 'SUMMARY' 			}      
...
function fnGridOnClick_edit_3rd(model, rowIndex, record){
	...
	// var selectedCell = GridClass_edit_3rd.grid.cellModel.getSelectedCell();
...
var	userColumns_edit_1st	= [ {header: '상태'        ,width:  0,  sortable: true ,dataIndex: 'FLAG'               , hidden : true}
		  ...
		  , {id:'ord_info_seq',  header: "순번",			width: 0,	sortable: true,	dataIndex: "ORD_INFO_SEQ"		, hidden:true}
							  , {header: "품목코드",  	width: 130,	sortable: true,	dataIndex: "ITEM_CODE"			}
							  , {header: "품목명",		width: 180,	sortable: true,	dataIndex: "ITEM_NAME"			}
							  , {header: "수량",			width: 40,	sortable: true,	dataIndex: "CNT"				, align : 'right'}
							  , {header: "총액",			width: 85,	sortable: true,	dataIndex: "UNIT_PRICE"			, renderer: "korMoney" , align : 'right'}
							  , {header: "금액",			width: 85,	sortable: true,	dataIndex: "AMT"				, renderer: "korMoney" , align : 'right'}
							  ...
							  , {header: "적용단가",		width: 85,	sortable: true,	dataIndex: "APLY_UNIT_PRICE"	, renderer: "korMoney" , align : 'right'}
							  , {header: "적용금액",		width: 85,	sortable: true,	dataIndex: "APLY_AMT"			, renderer: "korMoney" , align : 'right'}
							  , {header: "적용세액",		width: 85,	sortable: true,	dataIndex: "APLY_TAX"			, renderer: "korMoney" , align : 'right'}
							  , {header: "비고",			width: 100,	sortable: true,	dataIndex: "NOTE"				}
							  , {header: "최종변경자ID",	width: 0,	sortable: true,	dataIndex: "FINAL_MOD_ID"		, hidden:true}
							  , {header: "최종변경일시",	width: 0,	sortable: true,	dataIndex: "FINAL_MOD_DATE"		, hidden:true}
							  ];
						...
						<div class="x-panel-tr">
							<div class="x-panel-tc">
								<div id="ext-gen4" class="x-panel-header x-unselectable" style="-moz-user-select: none;">
									<span id="ext-gen8" class="x-panel-header-text">수주진행상태  검색</span>
								</div>
							</div>
						</div>
					</div>
										...
										<td width="20%">
											<div tabindex="-1" class="x-form-item " >
												...
												<div style="padding-left: 61px;" class="x-form-element">
													<input type="text" name="src_ord_custom_name" id="src_ord_custom_name" autocomplete="off" size="19" class=" x-form-text x-form-field" style="width: auto;">		
