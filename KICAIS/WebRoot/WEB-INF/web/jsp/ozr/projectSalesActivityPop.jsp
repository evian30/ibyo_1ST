<%--
  Class Name  : projectSalesActivityPop.jsp
  Description : 프로젝트별 영업비용분석
...
function fnOzReport(){
 ...
 //	var emp_num   	= Ext.get('src_emp_num').getValue()		// 사원번호  
 	...
 	var param = '?param=FROMDATE='+date_from+',TODATE='+date_to;
    var param = param+'&odi=ProjectSalesActivity&ozr=ProjectSalesActivity';
