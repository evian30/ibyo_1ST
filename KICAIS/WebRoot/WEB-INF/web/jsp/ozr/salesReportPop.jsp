<%--
  Class Name  : salesReportPop.jsp
  Description : 연도별 매출보고서
...
Ext.onReady(function() { 
	...
	// 세금계산서버튼
	Ext.get('taxIdBtn').on('click', function(e){
    	alert("세금계산서ID");
	//    var param = "";
	//	fnTaxPop(param);
    });
...
function fnOzReport(){
	...
	var pjt_id	  = Ext.get('src_tax_id').getValue()	// 프로젝트ID  
 	var tax_id	  = Ext.get('src_pjt_id').getValue()	// 세금계산서ID  
 	
 	var param 	  = '?param=TAX_ID='+tax_id+',PJT_ID='+pjt_id;
    var param 	  = param+'&odi=SDMS_SalesReport&ozr=SDMS_SalesReport';
	var sURL      = "/ozr/ozReportPop.sg"+param;
	var dlgWidth  = 820;
	var dlgHeight = 630;
	var winName   = "SDMS_SalesReport";
	fnOpenPop(sURL, dlgWidth, dlgHeight, winName);
}
</script>
											...
											<div tabindex="-1" class="x-form-item " >
												<div style="padding-left: 9px;" >
													<table>
														<tr>
															<td>
																<input type="text" name="src_tax_id" id="src_tax_id" autocomplete="off" size="30" style="width: auto;">		
															</td>
															<td valign="center">
																<%-- 검색하기버튼 Start --%>
																<div style="padding-left: 1px;" >
<%--																	<img align="center" id="taxIdBtn" name="taxIdBtn" alt="" src="/resource/images/bass_1st/icon_src1.gif" style="cursor: hand;">--%>
																</div>
																<%-- 검색하기버튼 End	--%>
															</td>
														</tr>
