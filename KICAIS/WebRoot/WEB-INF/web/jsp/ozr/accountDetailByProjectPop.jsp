<%--
  Class Name  : accountDetailByProjectPop.jsp
  Description : 프로젝트 상세비용분석
...
function fnOzReport(){
	...
	var date_from	= Ext.get('src_date_from').getValue()	// 검색시작일  
 	...
 	var pjt_id   	= Ext.get('src_pjt_id').getValue()		// 사원번호  
 	
 	var param = '?param=FROMDATE='+date_from+',TODATE='+date_to+',PJT_ID='+pjt_id;
    var param = param+'&odi=AccountDetailByProject&ozr=AccountDetailByProject';
	var sURL      = "/ozr/ozReportPop.sg"+param;
	var dlgWidth  = 820;
	var dlgHeight = 630;
	var winName   = "accountDetailByProject";
	fnOpenPop(sURL, dlgWidth, dlgHeight, winName);
}
</script>
