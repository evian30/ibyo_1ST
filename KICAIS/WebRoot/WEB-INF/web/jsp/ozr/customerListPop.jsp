<%--
  Class Name  : customerListPop.jsp
  Description : 고객리스트(등급)
...
function fnOzReport(){
	...
	var date_from	= Ext.get('src_date_from').getValue()	// 검색시작일  
 	...
 	var year		= Ext.get('src_year').getValue()	 
 //	var emp_num   	= Ext.get('src_emp_num').getValue()		// 사원번호  
 	
 	var param = '?param=FROMDATE='+date_from+',TODATE='+year;
    var param = param+'&odi=CustomerList&ozr=CustomerList';
	var sURL      = "/ozr/ozReportPop.sg"+param;
	var dlgWidth  = 820;
	var dlgHeight = 630;
	var winName   = "projectSalesActivity";
	fnOpenPop(sURL, dlgWidth, dlgHeight, winName);
}
</script>
											...
											<div tabindex="-1" class="x-form-item " >
												<div style="padding-left: 9px;" >
													...
													<table>
														<tr>
															<td>
																<input type="text" name="src_year" id="src_year" autocomplete="off" size="10" style="width: auto;" maxlength="4">
															</td>
															<td valign="center">
																<%-- 검색하기버튼 Start --%>
