...
<!-- 
	...
	function jf_search(){
	 ...
	 function jf_view(chman_no, corp_no){
		document.vFormList.actType.value = 'view';
		document.vFormList.chman_no.value = chman_no; 
		document.vFormList.action = "/sgportal/chman/chmanView.sg";
		document.vFormList.submit();
	 }
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="grid"> 
			...
			<tr>
				...
				<td>
					<c:choose>
						<c:when test="${pMap.actType == 'ins' || pMap.actType == 'mod'}">
							<input type="text" name="zipcode1" id="zipcode1" value="${fn:substring(companyView.ZIPCODE ,0,3)}" style="width:50px" maxlength="3" readonly/>-
							<input type="text" name="zipcode2" id="zipcode2" value="${fn:substring(companyView.ZIPCODE ,3,7)}" style="width:50px" maxlength="3" readonly/><br/>
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${groups}" var="group" varStatus="i"> 
									<input type="button" class="button02" value="수정" onclick="jf_chmanModForm()">
