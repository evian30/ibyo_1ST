...
var start_1st		=	0;
var proxyUrl_1st	= "/com/employee/result_1st.sg";
...
function fnSearch(){
	Ext.Ajax.request({   
		url: "http://test.sgis.com:8080/com/employee/result.sg"
		,method : 'POST'   
...
function fnSave(str){  	
	...
	if(str == ""){ 
		Ext.Msg.alert('확인', '아이디 중복체크를 확인해주세요.'); 
		return false;
	
	}else if(document.detailForm.passwd.value != "" && document.detailForm.passwd.value != document.detailForm.re_passwd.value){
...
function fnPagingValue_1st(){
	try{
    	GridClass_1st.store.setBaseParam('src_dept_name', Ext.get(dept_name).getValue());
    	GridClass_1st.store.setBaseParam('src_postion_code', Ext.get(searchPostion_code).getValue());
    	GridClass_1st.store.setBaseParam('src_kor_name',     Ext.get(searchKor_name).getValue());
		//GridClass_1st.store.setBaseParam('start_1st', GridClass_1st.store.lastOptions.params.start_1st);
		//GridClass_1st.store.setBaseParam('limit_1st', GridClass_1st.store.lastOptions.params.limit_1st);
	}catch(e){
					...
					<div class="x-panel-bwrap" >
						<div class="x-panel-ml">
							<div class="x-panel-mr">
								<div class="x-panel-mc" >
									<!-- 폼 시작 -->
									<form id="detailForm" name="detailForm" method="POST" class="x-panel-body x-form" style="padding: 5px 5px 0pt; width: 480px; height: 365px;">
	...
	<div class="x-panel-bwrap" >
		<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
			<div tabindex="-1" class="x-form-item " >
				...
				<div style="padding-left: 80px;" class="x-form-element">
					<input type="text" name="id" id="id" autocomplete="off" size="7" class=" x-form-text x-form-field" style="width: auto;">
					 
					<button type="button" id="detailClearBtn" class="x-btn-text" onclick="jf_idCheck()">중복체크</button> 
...
<div class=" x-panel x-column" style="width: 50%;">
	<div class="x-panel-bwrap" >
		...
		<div class="x-panel-body x-panel-body-noheader" style="width: 100%;">
			<div tabindex="-1" class="x-form-item " >
				<label class="x-form-item-label" style="width: auto;" for="passwd" >비밀번호:</label>
				<div style="padding-left: 80px;" class="x-form-element">
					<input type="text" name="passwd" id="passwd" autocomplete="off" size="22" class=" x-form-text x-form-field" style="width: auto;"> 
				</div>
				<div class="x-form-clear-left">
				</div>
			</div>
			<div tabindex="-1" class="x-form-item ">
				<label class="x-form-item-label" style="width: auto;" for="re_passwd" >비밀번호확인:</label>
				<div style="padding-left: 80px;" class="x-form-element">
					<input type="text" name="re_passwd" id="re_passwd" autocomplete="off" size="22" class=" x-form-text x-form-field" style="width: auto;">
				</div>
				<div class="x-form-clear-left">
				</div>
			</div>
