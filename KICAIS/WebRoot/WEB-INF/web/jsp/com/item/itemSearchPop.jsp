...
var gridTitle_2nd 		= "품목조회결과";							// 그리드 제목
var	render_2nd			= "user-grid";	        				// 렌더(화면에 그려질) 할 id 
var	pageSize_2nd		= 10;	  								// 그리드 페이지 사이즈	
var	proxyUrl_2nd		= "/com/item/itemPopList.sg";  		// 결과 값 페이지
...
var userColumns_2nd =  [ {header: "상태",		width: 100, sortable: true, dataIndex: 'FLAG', 			    editor: new Ext.form.TextField({}) , hidden : true} 
					    ,{header: "구분",		width: 50,  sortable: true, dataIndex: 'ITEM_TYPE', 		editor: new Ext.form.TextField({}) }
						,{header: "품목코드", 	width: 80, 	sortable: true, dataIndex: 'ITEM_CODE', 		editor: new Ext.form.TextField({}) , hidden : true}       
						,{header: "품목구분코드",	width: 60,  sortable: true, dataIndex: 'ITEM_TYPE_CODE', 	editor: new Ext.form.TextField({}) , hidden : true}                                                    
						,{header: "품목명", 		width: 180,	sortable: true, dataIndex: 'ITEM_NAME', 		editor: new Ext.form.TextField({}) }                  
						...
						,{header: "버전", 		width: 40,  sortable: true, dataIndex: 'ITEM_VERSION', 		editor: new Ext.form.TextField({}) }
						,{header: "단가", 		width: 80,  sortable: true, dataIndex: 'UNIT_PRICE_01', 	editor: new Ext.form.TextField({}) , renderer: korMoneyChangeRED, align:'right'}  
...
function fnGridOnClick_2nd(store, rowIndex){
	...
	*/
	...
	window.opener.fnItemSearchPopValue(records, '<%= openerGridName%>');
	window.close();
										...
										<td width="32%">
											...
											<div tabindex="-1" class="x-form-item " >
												...
												<div style="padding-left:30px;" class="x-form-element">
													<input type="text" name="src_item_name" id="src_item_name" autocomplete="off" class=" x-form-text x-form-field" style="width: 100px;">
												</div>
										...
										<td width="32%">
											...
											<div tabindex="-1" class="x-form-item " >
												...
												<div style="padding-left:80px;" class="x-form-element">
													<select name="src_item_pattern_code" id="src_item_pattern_code" style="width: 51%;" type="text" class=" x-form-select x-form-field" >
