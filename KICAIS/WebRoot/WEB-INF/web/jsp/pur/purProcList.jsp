...
var userColumns_edit_3rd =  [
					{header: "진행상태",			width: 100 ,sortable: true, dataIndex: 'PROC_STATUS_CODE', 	editor: INSPECT_RESULT_COMBO, renderer: Ext.util.Format.comboRenderer(INSPECT_RESULT_COMBO) }
					,{header: "검수일자",			width: 100 ,sortable: true, dataIndex: 'INSPECT_DATE', 		editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
					,{header: "검수담당자이름",	width: 80 ,sortable: true, dataIndex: 'INSPECT_EMP_NAME', 	editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
					,{header: "검수내용",			width: 200 ,sortable: true, dataIndex: 'INSPECT_DESC', 		editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
					...
					,{header: "비고",			width: 80 ,sortable: true, dataIndex: 'NOTE', 				editor: new Ext.form.TextField({}) }
					
					
					,{header: "구매ID",  		width: 100 ,sortable: true, dataIndex: 'PUR_ID', 	 		editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
					,{header: "구매구분코드", 		width: 80 ,sortable: true, dataIndex: 'PUR_TYPE_CODE', 	editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
					,{header: "프로젝트ID",	 	width: 80 ,sortable: true, dataIndex: 'PJT_ID', 	 		editor: new Ext.form.TextField({}) ,editable:false , hidden : true}
