...
<%
	...
	String estId = request.getParameter("estId");					// 견적ID
	String pjtId = request.getParameter("pjtId");					// 프로젝트ID
%>
...
var	proxyUrl_1st_pop		= "/est/estimate/estimateInfoManageRevPopList.sg"; // 결과 값 페이지
...
var userColumns_1st_pop =  [ checkSm,
						   ...
						   , {header: '견적구분'            	,width: 60  ,sortable: true ,dataIndex: 'EST_TYPE_NAME'         ,hidden : true}
						   ...
						   , {header: '버전'                	,width: 60  ,sortable: true ,dataIndex: 'EST_VERSION'			}
						   , {header: '거래처'           	,width: 60  ,sortable: true ,dataIndex: 'CUSTOM_NAME'           } 
						   , {header: '견적담당자'      		,width: 60  ,sortable: true ,dataIndex: 'EST_EMP_NAME'          }
						   ...
						   , {header: 'REV버전'   		    ,width: 60  ,sortable: true ,dataIndex: 'FINAL'     		    ,hidden : true}
					   	   ];	 
...
var mappingColumns_1st_pop = [ 
							 ...
							 , {name: 'FINAL'     			, allowBlank: false}	// REV버전
					    	 ];
...
function fnSearch(){  	
	...
	Ext.Ajax.request({   
		url: "/est/estimate/estimateInfoManageRevPopList.sg"
		,method : 'POST'   
...
function fnPagingValue_1st_pop(){
	...
	try{
    	...
    	GridClass_1st_pop.store.setBaseParam('src_pjt_id'  ,Ext.get('src_pjt_id').getValue());
...
function fnSelectPopUpGridRow1st(){
	...
	if(records.length == 0){
		...
		window.opener.fnEstimateInfoManagePopValue(records);
		window.close();
	}
}
</script>
						    			...
						    			<td width="50%">
											<div tabindex="-1" class="x-form-item " >
												...
												<div style="padding-left: 0px;" class="x-form-element">
													<input type="text" id="src_pjt_id" name="src_pjt_id" autocomplete="off" size="18" class=" x-form-text x-form-field" style="width: auto;" value="<%=pjtId%>">
												</div>
											</div>
										</td>
										<td width="50%">
											<div tabindex="-1" class="x-form-item " >
												...
												<div style="padding-left: 0px;" class="x-form-element">
													<input type="text" id="src_est_id" name="src_est_id" autocomplete="off" size="20" class=" x-form-text x-form-field" style="width: auto;" value="<%=estId%>">
												</div>
											</div>
										</td>
									</tr>
